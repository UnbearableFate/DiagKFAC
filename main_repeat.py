...
for i in range(4):
    args_repeat = deepcopy(args)
    args_repeat.kfac_kl_clip = args_repeat.kfac_kl_clip * 10**(i)
    args_repeat.experiment_name = args_repeat.experiment_name + f'_kfac_kl_clip_{args_repeat.kfac_kl_clip}'
    mgr = Trainer(args_repeat)
